...
class ProxyRotationEngine:
    ...
    def __init__(self, stats_manager: ProxyStatsManager, config: RotationConfig | None = None):
        """
    ...
    def get_scored_proxies(self, country: str | None = None) -> list[tuple[ProxyStats, float]]:
        """
    ...
    def select_proxy(self, country: str | None = None) -> str | None:
        """
    ...
    def select_proxy_with_score(self, country: str | None = None) -> tuple[str, float] | None:
        """
    ...
    def select_best_proxy(self, country: str | None = None) -> str | None:
        """
    ...
    def get_proxy_ranking(self, country: str | None = None, limit: int = 10) -> list[dict]:
        """
    ...
    def explain_score(self, proxy_id: str) -> dict | None:
        """
