...
class ProxySessionManager:
    ...
    def __init__(self, credentials: ProxyCredentials, sticky_duration: int = 600):
        ...
        logger.info(f"ProxySessionManager initialized (host: {credentials.host}:{credentials.port})")
    ...
    def get_session_by_profile(self, profile_id: str) -> Optional[ProxySession]:
    ...
    def test_session(self, session: ProxySession, timeout: int = None) -> Tuple[bool, Optional[str]]:
        """
