...
class EventLogger:
    ...
    def __init__(
        ...
        self._writer_thread = threading.Thread(
            target=self._writer_loop, daemon=True, name="EventLoggerWriter"
        )
    ...
    @classmethod
    def get_instance(
        cls, store: EventStore | None = None, db_path: Path | None = None, **kwargs
    ) -> "EventLogger":
        """
    ...
    def log_profile_stopped(
        self, session_id: str, profile_id: str, os: str, vps_id: str, **metadata
    ):
    ...
    def log_proxy_disabled(self, proxy_id: str, os: str, vps_id: str, reason: str, **metadata):
    ...
    def log_proxy_enabled(self, proxy_id: str, os: str, vps_id: str, **metadata):
    ...
    def log_behavior_event(
        self, session_id: str, profile_id: str, os: str, vps_id: str, behavior_type: str, **metadata
    ):
        """Log BEHAVIOR_EVENT."""
        self.log(
            create_behavior_event(
    ...
    def log_navigation_start(
        self, session_id: str, profile_id: str, os: str, vps_id: str, url: str, **metadata
    ):
    ...
    def log_wave_started(
        self, wave_number: int, session_count: int, os: str, vps_id: str, **metadata
    ):
