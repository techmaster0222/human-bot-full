...
from ..proxy.session_manager import ProxySessionManager, ProxySession
...
class ProfileFactory:
    ...
    def create_profile(
        ...
        fingerprint_template: Optional[Dict] = None,
        ...
        logger.success(f"Created profile: {profile_name} (ID: {profile_id}, session: {proxy_session.session_id})")
        return profile_info
    
    def get_profile_info(self, profile_id: str) -> Optional[ProfileInfo]:
