...
class CooldownManager:
    ...
    def start_cooldown(
        self, profile_id: str, duration_seconds: int | None = None, reason: str = ""
    ) -> CooldownEntry:
        """
    ...
    def get_entry(self, profile_id: str) -> CooldownEntry | None:
    ...
    def clear_expired(self) -> int:
        ...
        """
        expired = [pid for pid, entry in self._cooldowns.items() if entry.is_expired]
